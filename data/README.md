...
contains:
- `preprocessed/`: raw wav files and links to relevant files
- `processed/`: broken up wav files, serialized recording extractor objects for both the recording and the wav files
